...
class PromptBuilder:
    def build(self, data: PromptBuilderInput) -> PromptBundle:
        ...
        system_prompt = (
            ...
            "If you can reliably identify the relevant NCERT book/unit/chapter from your own knowledge, include a Source block at the end. "
            "If you cannot reliably identify an NCERT source, do not invent one; include one Learn More YouTube search link instead. "
        ...
        user_prompt = (
            ...
            "- If possible, identify the relevant NCERT source and add it at the end in this format:\n"
            "  Source:\n"
            "  NCERT\n"
            "  Book: <book name>\n"
            ...
            "- If you are not reasonably confident about the NCERT source, omit the Source block and add Learn More with exactly one YouTube search link.\n\n"
            "Instructions\n"
    ...
    def _language_instruction(self, preferred_language: str) -> str:
        ...
        if key == "hindi":
            return (
                ...
                "Do not write Roman Hindi or Hinglish. Translate section headings, labels, bullets, teaching tips, and prompts into Hindi. "
        ...
        *,
        ...
        if key == "hindi":
            return (
                ...
                f"ग्रेड/कक्षा: {grade}\n"
                f"विषय: {subject}\n"
                f"अवधि: {duration_minutes} minutes\n\n"
                "पाठ शीर्षक\n"
