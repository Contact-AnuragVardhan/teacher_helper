...
class PromptBuilder:
    def build(self, data: PromptBuilderInput) -> PromptBundle:
        ...
        if not context_block:
            context_block = "No NCERT snippets were retrieved. Use a safe, classroom-ready deterministic lesson structure."

        system_prompt = (
            "You are a lesson planning assistant for Indian K-12 teachers. "
            "Stay aligned to the provided NCERT context. Use simple teacher-friendly language. "
